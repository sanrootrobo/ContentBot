...
class SEOBlogWriter:
    ...
    # MODIFIED: Prompt now includes NLP-friendly and Humanizing instructions
...
*   **Structure:** Use simple, direct sentences. Follow a Subject-Verb-Object order where possible.
