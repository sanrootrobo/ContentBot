...
class BlogInput:
    ...
    # --- THIS LINE WAS ADDED BACK TO FIX THE ERROR ---
...
class QueryGenerator:
    ...
    def _build_prompt(self, blog_input: BlogInput) -> str:
        return f"""
You are a world-class research assistant. Your task is to generate a list of Google search queries to gather information for a blog post with the following details:
...
1.  **news_queries:** To find the absolute latest news, announcements, trends, and product releases. These should be designed to be sorted by date.
2.  **fact_queries:** To find foundational, evergreen information like definitions, explanations, core benefits, and how-to guides.

**CRITICAL:** Respond with ONLY a valid JSON object containing the two keys "news_queries" and "fact_queries". Do not include any other text or markdown.
